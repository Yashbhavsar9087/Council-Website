...
function myFunction() {
  ...
  function tenure2020() {
	var x = document.getElementById("tenure2020");
	if (x.style.display === "none") {
	  x.style.display = "block";
	} else {
	  x.style.display = "none";
	}
	var y = document.getElementById("tenure2019");
	 y.style.display = "none";

	var z = document.getElementById("tenure2018");
	z.style.display = "none";

	var a = document.getElementById("tenure2017");
